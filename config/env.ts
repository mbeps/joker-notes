 ...
 * @param isServerEnv - Whether current context is server runtime (defaults to typeof window === "undefined")
...
export function validateClientEnv(
  ...
  return validateEnv(runtimeEnv, false);
}
...
export function validateServerEnv(
  ...
  return validateEnv(runtimeEnv, true);
}
